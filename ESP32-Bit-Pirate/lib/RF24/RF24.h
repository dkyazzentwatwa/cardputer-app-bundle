...
public:
    ...
    /**
     * Same as begin(_SPI*), but re-initializes the SPI bus with explicit pins
     * after RF24 GPIO setup and immediately before the first radio register access.
     */
    bool begin(_SPI* spiBus, int8_t sck, int8_t miso, int8_t mosi, int8_t ss);
