...
void CardputerView::displayTopBar(const std::string& title, bool submenu, bool searchBar) {
    ...
    if (searchBar) {
        ...
        // To center text
        offsetX = utils::StringUtils::getTextCenterOffset(searchQuery, textWidth, sizeText);
        ...
        // To center text
        offsetX = utils::StringUtils::getTextCenterOffset(formattedTitle, textWidth, sizeText);
