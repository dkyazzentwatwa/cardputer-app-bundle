...
void CartridgeAR::initializeROM()
{
  ...
  CartridgeAR::ourDummyROMCode = (uInt8*)malloc(294);
  if (!CartridgeAR::ourDummyROMCode)
      return;

  memcpy(CartridgeAR::ourDummyROMCode, ourDummyROMCodeTemplate, 294);
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
uInt8* CartridgeAR::ourDummyROMCode = nullptr;
const uInt8 CartridgeAR::ourDummyROMCodeTemplate[] = {
