...
static void    Z80_BuildParityTable(void)
{
	...
	if (ParityTable == NULL)
	{
		ParityTable = (unsigned char *)malloc(256);
		ZeroSignTable = (unsigned char *)malloc(256);
		ZeroSignTable2 = (unsigned char *)malloc(256);
		ZeroSignParityTable = (unsigned char *)malloc(256);
