...
/* Keep old inline helpers valid across compilers/build flags. */
#ifndef INLINE
...
/*
 * Avoid global symbol collisions with other emulator cores in this firmware.
 * Arnold code includes this header, so these remaps stay local to Arnold.
 */
#define Z80_Init ARNOLD_Z80_Init
#define Z80_Reset ARNOLD_Z80_Reset
